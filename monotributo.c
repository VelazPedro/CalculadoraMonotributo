 ...
 *
 *  Categorías A-D: impuesto integrado igual para servicios y bienes.
 *  Categorías E-K: servicios tributan más que bienes en impuesto integrado.
 *
...
/*  L    Tope anual        Srv imp    Bien imp   SIPA       Obra social  */
  {'A',  8992597.87,       4182.60,   4182.60,   13663.17,  19239.97},
  {'B', 13175201.52,       7946.95,   7946.95,   15029.49,  19239.97},
  {'C', 18473166.15,      13663.17,  12547.81,   16532.44,  19239.97},
  {'D', 22934610.05,      22307.22,  20773.60,   18185.68,  22864.90},
  {'E', 26976028.86,      40591.91,  15553.60,   26865.68,  24499.65},
  {'F', 33791063.24,      55408.81,  30370.50,   32266.43,  26317.50},
  {'G', 40407157.75,      80295.20,  37551.16,   37551.16,  26317.50},
  /*  Categorías H–K sólo para actividades de servicios/locaciones          */
  {'H', 60546831.72,     146060.00,  0.00,       69518.00,  31656.40},
  {'I', 67360540.24,     219032.00,  0.00,       78784.00,  38745.00},
  {'J', 77654090.14,     254326.00,  0.00,       91069.00,  44117.00},
  {'K', 94805682.90,    1024737.89,  341579.30, 118346.41,  65806.30}
};

/* ── Precio máximo unitario (venta bienes) ──────────────────────────────── */
#define PRECIO_MAX_UNIDAD  613492.31
